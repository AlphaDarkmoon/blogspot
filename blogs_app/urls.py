...
urlpatterns = [
    ...
    path ('all_blogs', views.AllBlogsView, name='all-blogs'),                                                                                     
    ...
    path('1/password/',auth_views.PasswordChangeView.as_view(template_name = 'extra/register_users/change_pass.html')),
    path('password/',ChangePasswordsView.as_view(template_name = 'extra/register_users/change_pass.html'),name='change-password'),     
